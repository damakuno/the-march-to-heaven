...
namespace DialogueEditor
{
    public class ConversationManager : MonoBehaviour
    {
        ...
        public bool isBackgroundPermanent;
        ...
        private void TurnOnUI()
        {
            if (isBackgroundPermanent)
            {
                // only enable name, char sprite, dialogue text
        ...
        private void TurnOffUI()
        {
            if (isBackgroundPermanent)
            {
                // only disable name, char sprite, dialogue text
