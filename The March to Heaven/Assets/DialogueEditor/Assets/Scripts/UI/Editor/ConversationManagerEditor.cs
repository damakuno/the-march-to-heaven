...
namespace DialogueEditor
{
    ...
    public class ConversationManagerEditor : Editor
    {
        ...
        SerializedProperty BackgroundImagePermProperty;
        ...
        private void OnEnable()
        {
            ...
            BackgroundImagePermProperty = serializedObject.FindProperty("isBackgroundPermanent");
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.PropertyField(BackgroundImagePermProperty);
